---
description: "Ship a bug fix with GitHub issue comment: simplify code, commit, push, create PR, code review, fix all issues, then comment on the GitHub issue with install/test/debug instructions."
---
