...
|-----------|-----------|-----|
| REST API + WebSocket protocol | 318 operations across 54 route groups | `docs/API.md` (+ `docs/openapi.yaml`) |
...
| Services / DB schema / plugins / peer comms | 87 services, 82 tables, terminal-type plugins, inter-agent messaging | `docs/ARCHITECTURE.md` |
