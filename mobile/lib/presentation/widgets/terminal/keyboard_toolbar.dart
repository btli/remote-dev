      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            // Row 1: Special keys
            _buildRow([
              const _ToolbarKey('ESC', '\x1b'),
              const _ToolbarKey('TAB', '\t'),
              _ToolbarKey(
                'CTRL',
                'ctrl',
                isModifier: true,
              ...
              const _ToolbarKey('\u2191', '\x1b[A'),
              const _ToolbarKey('\u2193', '\x1b[B'),
              const _ToolbarKey('\u2190', '\x1b[D'),
              const _ToolbarKey('\u2192', '\x1b[C'),
            ]),
