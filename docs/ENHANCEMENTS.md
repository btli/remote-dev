...
| Multi-agent CLI support (7) | Claude Code, OpenAI Codex, Gemini CLI, Antigravity, OpenCode, Cursor, Kimi Code — installation detection, version checks, and launch metadata. Antigravity has no public installer and no session resume. |
