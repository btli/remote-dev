...
| Doc | Description |
|-----|-------------|
| [AGENTS.md](AGENTS.md) | The 7 agent CLIs (Claude Code, Codex, Gemini, Antigravity, OpenCode, Cursor, Kimi), including quick starts, profile isolation, appearance, CLI verification, resume, and Claude usage-limit handling |
