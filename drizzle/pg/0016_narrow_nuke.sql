CREATE TABLE "claude_usage_limit_window" (
	...
	"scope_model" text,
	"scope_model_key" text DEFAULT '' NOT NULL,
	"scope_surface" text,
...
CREATE INDEX "claude_usage_limit_window_user_idx" ON "claude_usage_limit_window" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "claude_usage_limit_window_key_unique" ON "claude_usage_limit_window" USING btree ("account_id","kind","scope_model_key");