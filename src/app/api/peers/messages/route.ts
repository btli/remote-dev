...
/** Verify the user owns the given project (legacy folderId). */
async function verifyFolderOwnership(projectId: string, userId: string): Promise<boolean> {
...
export const GET = withApiAuth(async (request, { userId }) => {
  try {
    ...
    const messages = await PeerService.listProjectMessages(folderId, limit);
