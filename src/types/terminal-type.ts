 ...
 */
export type TerminalType = "shell" | "agent" | "file" | "browser" | "settings" | "recordings" | "issues" | "prs" | "profiles" | "port-manager" | "trash" | "project-prefs" | "github-maintenance" | string;

/**
 * Built-in terminal types (cannot be unregistered)
 */
export const BUILT_IN_TERMINAL_TYPES: TerminalType[] = ["shell", "agent", "file", "browser", "loop", "settings", "recordings", "issues", "prs", "profiles", "port-manager", "trash", "project-prefs", "github-maintenance"];
...
/**
 * Browser pane metadata stored with the session
 */
