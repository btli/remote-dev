          ...
          <ScrollArea className="max-h-[calc(85vh-140px)] pr-4">
            <div className="space-y-4 mt-3">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="edit-schedule-name" className="text-xs text-slate-300">
                ...
                {scheduleType === "one-time" && (
                  <div className="space-y-2">
                    <div className="grid grid-cols-2 gap-2.5">
                      <div className="space-y-1.5">
                        <Label htmlFor="edit-scheduled-date" className="text-xs text-slate-400">
                          Date *
                        </Label>
                        <Input
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="edit-scheduled-time" className="text-xs text-slate-400">
                          Time *
                        </Label>
                        <Input
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 space-y-1.5">
                          <Textarea
                            ...
                            className="min-h-[50px] text-xs bg-slate-800/50 border-white/10 font-mono resize-none"
                          />
                        ...
                        <Button
                          ...
                          className={cn(
                            "h-6 w-6 text-slate-500 hover:text-red-400",
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <Button
                  onClick={handleSave}
                  disabled={isSaving}
                  className="h-8 text-xs bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700"
                >
                  {isSaving ? (
                    <>
